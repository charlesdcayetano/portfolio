...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ba(e,t,n){let r=new Float32Array(oa),i=new q(0,1,0);return new ri({name:`SphericalGaussianBlur`,defines:{n:oa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ca(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xa(){return new ri({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ca(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Sa(){return new ri({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ca(),fragmentShader:`
	...
	`}var wa=class extends Ot{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ur(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Xo={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Zo(e,t){let n=Xo[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Qo=new q;function $o(){return Y.getLuminanceCoefficients(Qo),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Qo.x.toFixed(4)}, ${Qo.y.toFixed(4)}, ${Qo.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Ho(i,i.VERTEX_SHADER,y),S=Ho(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Jo(i,x,`vertex`),n=Jo(i,S,`fragment`);U(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`;function pc(){let e=(0,r.useRef)(null),[t,n]=(0,r.useState)(()=>document.documentElement.classList.contains(`dark`));return(0,r.useEffect)(()=>{let e=new MutationObserver(()=>{n(document.documentElement.classList.contains(`dark`))});return e.observe(document.documentElement,{attributes:!0,attributeFilter:[`class`]}),()=>e.disconnect()},[]),(0,r.useEffect)(()=>{let n=e.current;if(!n||window.matchMedia(`(prefers-reduced-motion: reduce)`).matches)return;let r=t?new X(16561984):new X(16096779),i=new wi;i.position.z=1;let a=new mn,o=new Jr(2,2),s={time:{value:1},resolution:{value:new K},tintColor:{value:r}},c=new ri({uniforms:s,vertexShader:dc,fragmentShader:fc,transparent:!0}),l=new jr(o,c);a.add(l);let u=new lc({antialias:!0,alpha:!0});u.setPixelRatio(Math.min(window.devicePixelRatio,2)),n.appendChild(u.domElement);let d=()=>{let e=n.clientWidth,t=n.clientHeight;u.setSize(e,t),s.resolution.value.x=u.domElement.width,s.resolution.value.y=u.domElement.height};d(),window.addEventListener(`resize`,d);let f,p=()=>{f=requestAnimationFrame(p),s.time.value+=.05,u.render(a,i)};return p(),()=>{window.removeEventListener(`resize`,d),cancelAnimationFrame(f),n.contains(u.domElement)&&n.removeChild(u.domElement),u.dispose(),o.dispose(),c.dispose()}},[t]),(0,uc.jsx)(`div`,{ref:e,"aria-hidden":`true`,className:`pointer-events-none fixed inset-0 -z-10`})}export{pc as default};